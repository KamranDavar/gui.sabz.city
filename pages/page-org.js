...
/**
 * 
 * For non login person or they have no joined org show org introduce landing page
 * for login person show their org!
 */
export class PageOrg extends LitElement {
    // constructor() {
    //     super()
    // }
    ...
    render() {
        return html`
            ...
            <main>
                <!-- Authorized user can access or edit org data -->
                <!-- Data use in widget-org-visit-card -->
            </main>
...
customElements.define('page-org', PageOrg)
